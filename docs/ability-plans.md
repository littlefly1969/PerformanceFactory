...
Questa slice prepara tutte le abilità e ne rende accessibili attività e check-in. Non trasforma le attività AREA in `TrainingSession`, non le aggiunge automaticamente alle quattro/sei sessioni sportive e non impone finestre di 14 giorni ai cicli AREA. Il rinnovo automatico rolling continua a riguardare il piano sportivo; per le aree rimane il workflow di rinnovo esistente. Non viene sommato silenziosamente altro carico al calendario.
